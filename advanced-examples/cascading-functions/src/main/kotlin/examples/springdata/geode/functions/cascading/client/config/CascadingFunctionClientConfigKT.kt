...
//@EnableGemfireFunctionExecutions(basePackageClasses = [CustomerFunctionExecutionsKT::class, OrderFunctionExecutionsKT::class])
@EnableGemfireFunctionExecutions(basePackageClasses = [OrderFunctionExecutionsKT::class])
