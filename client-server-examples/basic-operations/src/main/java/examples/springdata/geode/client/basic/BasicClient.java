...
public class BasicClient {
    ...
    ApplicationRunner runner(CustomerService customerService) {
        return args -> {
            ...
            System.out
                    .println("Entries on Client: " + customerService.numberEntriesStoredLocally());
            System.out
                    .println("Entries on Server: " + customerService.numberEntriesStoredOnServer());
            customerService.findAll()
                    .forEach(customer -> System.out.println("\t Entry: \n \t\t " + customer));
