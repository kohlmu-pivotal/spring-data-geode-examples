...
public class BasicClientWithLocalCaching {
	...
	public static void main(String[] args) {
		ConfigurableApplicationContext applicationContext = SpringApplication
			.run(BasicClientWithLocalCaching.class, args);
		BasicClientWithLocalCaching client = applicationContext.getBean(BasicClientWithLocalCaching.class);
	...
	@ClientCacheApplication(name = "BasicClientWithLocalCaching", logLevel = "error",
