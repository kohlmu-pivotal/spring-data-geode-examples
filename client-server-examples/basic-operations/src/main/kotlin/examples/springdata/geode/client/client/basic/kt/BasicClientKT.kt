package examples.springdata.geode.client.client.basic.kt
 ...
 */
@SpringBootApplication(scanBasePackageClasses = [examples.springdata.geode.client.client.basic.kt.BasicClientApplicationConfigKT::class])
