...
@SpringBootApplication(scanBasePackageClasses = [BasicClientWithProxyKT::class])
class BasicClientWithProxyKT {

    @Resource
    internal lateinit var clientCustomerRegion: Region<String, Customer>

    @ClientCacheApplication(name = "BasicClientWithProxyKT", logLevel = "error", pingInterval = 5000L, readTimeout = 15000, retryAttempts = 1)
