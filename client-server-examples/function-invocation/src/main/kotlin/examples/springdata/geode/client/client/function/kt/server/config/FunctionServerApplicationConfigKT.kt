package examples.springdata.geode.client.client.function.kt.server.config

import examples.springdata.geode.client.common.kt.server.config.ServerApplicationConfigKT
import examples.springdata.geode.domain.Order
import examples.springdata.geode.domain.Product
import examples.springdata.geode.client.function.kt.server.repo.CustomerRepositoryKT
