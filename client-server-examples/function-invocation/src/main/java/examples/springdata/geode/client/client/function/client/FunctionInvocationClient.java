package examples.springdata.geode.client.client.function.client;

import examples.springdata.geode.client.client.function.client.services.CustomerService;
import examples.springdata.geode.client.client.function.client.services.OrderService;
import examples.springdata.geode.client.client.function.client.services.ProductService;
import examples.springdata.geode.client.client.function.client.config.FunctionInvocationClientApplicationConfig;
import examples.springdata.geode.client.client.function.client.services.CustomerService;
import examples.springdata.geode.client.client.function.client.services.OrderService;
import examples.springdata.geode.client.client.function.client.services.ProductService;
