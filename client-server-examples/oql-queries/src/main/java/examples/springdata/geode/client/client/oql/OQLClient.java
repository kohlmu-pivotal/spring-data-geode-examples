package examples.springdata.geode.client.client.oql;

import examples.springdata.geode.client.client.oql.config.OQLClientApplicationConfig;
import examples.springdata.geode.domain.Customer;
import examples.springdata.geode.domain.EmailAddress;
import examples.springdata.geode.client.client.oql.services.CustomerService;
