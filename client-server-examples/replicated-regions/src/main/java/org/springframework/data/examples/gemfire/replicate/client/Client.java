package org.springframework.data.examples.gemfire.replicate.client;
...
public class Client {
	...
	public static void main(String[] args) {
		ConfigurableApplicationContext applicationContext = SpringApplication.run(ClientKT.class, args);
		ClientKT client = applicationContext.getBean(ClientKT.class);
