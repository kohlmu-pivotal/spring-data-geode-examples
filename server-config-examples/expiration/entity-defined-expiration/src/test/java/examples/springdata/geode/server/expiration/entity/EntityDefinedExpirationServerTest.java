...
import examples.springdata.geode.server.expiration.entity.repo.CustomerRepository;
...
public class EntityDefinedExpirationServerTest {
    ...
    public void expirationIsConfiguredCorrectly() {
        customerRepository.save(new examples.springdata.geode.server.expiration.entity.domain.Customer(1L, new EmailAddress(faker.internet().emailAddress()),
